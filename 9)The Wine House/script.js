...
window.addEventListener('wheel', (e) => {
 ...
 if(bool){
  ( document.querySelector(
    `.section-${deltaY ? counter1 : counter2}`).style.left = `${deltaY ? "-100vw" : "0"}`);
...
document.querySelector('.left-btn').addEventListener('click', () => {
  ...
  if(bool){
    document.querySelector(`.section-${counter2}-wrapper`).style.transfrom = 'scale(1)';
    document.querySelector(`.section-${counter2 + 1}-wrapper`).style.transfrom = 'scale(1.5)';
  }
});
...
document.querySelector('.right-btn').addEventListener('click', () => {
  ...
  if(bool){
    document.querySelector(`.section-${counter2}-wrapper`).style.transfrom = 'scale(1)';
    document.querySelector(`.section-${counter1}-wrapper`).style.transfrom = 'scale(1.5)';
  }
});
